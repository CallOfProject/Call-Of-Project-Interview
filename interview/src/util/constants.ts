...
export const supportedLanguages: ProgrammingLanguageDTO[] = [
  new ProgrammingLanguageDTO("C", "C", "c", C_PRE_CODE_DEFAULT),
  new ProgrammingLanguageDTO("C++ 14", "C++14", "cpp", CPP_PRE_CODE_DEFAULT),
  new ProgrammingLanguageDTO("C++ 17", "C++17", "cpp", CPP_PRE_CODE_DEFAULT),
  new ProgrammingLanguageDTO("C#", "CSHARP", "csharp", CSHARP_PRE_CODE_DEFAULT),
  new ProgrammingLanguageDTO("Java 8", "JAVA8", "java", JAVA_PRE_CODE_DEFAULT),
  new ProgrammingLanguageDTO("Java 14", "JAVA14", "java", JAVA_PRE_CODE_DEFAULT),
  new ProgrammingLanguageDTO("Javascript", "JAVASCRIPT_NODE", "javascript", JAVASCRIPT_NODE_PRE_CODE_DEFAULT),
  new ProgrammingLanguageDTO("GO", "GO", "go", GO_PRE_CODE_DEFAULT),
  new ProgrammingLanguageDTO("Kotlin", "KOTLIN", "kotlin", KOTLIN_PRE_CODE_DEFAULT),
  new ProgrammingLanguageDTO("Python 2", "PYTHON", "python", PYTHON_PRE_CODE_DEFAULT),
  new ProgrammingLanguageDTO("Python 3", "PYTHON3", "python", PYTHON_PRE_CODE_DEFAULT),
  new ProgrammingLanguageDTO("Python 3.8", "PYTHON3.8", "python", PYTHON_PRE_CODE_DEFAULT),
  new ProgrammingLanguageDTO("PHP", "PHP", "php", PHP_PRE_CODE_DEFAULT),
  new ProgrammingLanguageDTO("R", "R", "r", R_PRE_CODE_DEFAULT),
  new ProgrammingLanguageDTO("Ruby", "RUBY", "ruby", RUBY_PRE_CODE_DEFAULT),
  new ProgrammingLanguageDTO("Rust", "RUST", "rust", RUST_PRE_CODE_DEFAULT),
  new ProgrammingLanguageDTO("Scala", "SCALA", "scala", SCALA_PRE_CODE_DEFAULT),
  new ProgrammingLanguageDTO("Swift", "SWIFT", "swift", SWIFT_PRE_CODE_DEFAULT),
  new ProgrammingLanguageDTO("Typescript", "TYPESCRIPT", "typescript", TYPESCRIPT_PRE_CODE_DEFAULT)];
